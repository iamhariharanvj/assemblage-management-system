...
const Signup = () => {
  ...
  <h1 className="text-3xl font-bold mb-8 text-black ">Join the Community!</h1>
  <form className="grid  grid-cols-2 gap-4  w-full max-w-screen-lg" onSubmit={handleSubmit}>
    ...
    <div className="text-gray-500 mt-6 text-center">
      Already a user? <Link to="/" className="text-purple-600 font-bold">Login here</Link>
    </div>
    </div>
    </div>
    );
